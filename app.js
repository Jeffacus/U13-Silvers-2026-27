...
function openMatch(id){
  ...
  ${m.id==='m2'?`<div class="report-heading">FULL-TIME MEDIA ///</div><div class="preview-media"><a class="cta wide" href="https://www.facebook.com/share/r/14rFrdhSK2L/?mibextid=wwXIfr" target="_blank" rel="noopener">🎬 WATCH FULL-TIME / MATCH REPORT VIDEO →</a></div>`:''}${m.id==='m3'?`<div class="report-heading">FULL-TIME MEDIA ///</div><div class="preview-media"><a class="cta wide" href="${NORTH_SHIELDS_FULLTIME_VIDEO}" target="_blank" rel="noopener">🎬 WATCH FULL-TIME / MATCH REPORT VIDEO →</a></div>`:''}
